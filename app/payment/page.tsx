...
function PaymentContent() {
  ...
  const [formData, setFormData] = useState({
    ...
    SUCCESS_URL: typeof window !== 'undefined' ? `${window.location.protocol}//${window.location.host}/payment/success` : 'http://localhost:3000/payment/success',
    FAILURE_URL: typeof window !== 'undefined' ? `${window.location.protocol}//${window.location.host}/payment/failure` : 'http://localhost:3000/payment/failure',
    CHECKOUT_URL: typeof window !== 'undefined' ? `${window.location.protocol}//${window.location.host}/payment/checkout` : 'http://localhost:3000/payment/checkout',
